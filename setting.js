...
//    })();
   ...
   var settingcont = document.getElementById("setting-cont");

   settingbtn.onclick = function() {
    if(settingcont.className=="none"){
        settingcont.className="box";
    }
   }

   var savebtn = document.getElementById("save");
   var cancbtn = document.getElementById("cancel");

   savebtn.onclick = function() {
    if(settingcont.className=="box"){
        settingcont.className="none";
    }
   }
